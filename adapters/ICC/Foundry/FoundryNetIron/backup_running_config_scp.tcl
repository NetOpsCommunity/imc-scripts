...
#**************************************************************************
#Identification: backup_running_config_scp
#Purpose:        backup running configuration by cli via scp.
#**************************************************************************
...
if { $keyfile != "" } {
   spawn pscp -scp -i \"$keyfile\" $username@$deviceip:runConfig $FileName
} else {
   spawn pscp -scp $username@$deviceip:runConfig $FileName
}

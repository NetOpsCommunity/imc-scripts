...
#**************************************************************************
# Identification:backup_startup_config_scp
# Purpose:       backup startup configuration by scp
#**************************************************************************
...
if { $keyfile != "" } {
   spawn pscp -scp -i \"$keyfile\" $username@$deviceip:startConfig $FileName
} else {
   spawn pscp -scp $username@$deviceip:startConfig $FileName
}

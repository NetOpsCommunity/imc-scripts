...
#**************************************************************************
	...
	send "copy ftp://$FTPUser:$FTPPassword@$TFTPServer/$TFTPFile running-config\r"
    expect {
		"uthorization failed" {
			set ERROR_MESSAGE "The user is not authorized to use the command copy ftp running-config"
